...
- V2 recolhe o `Menu_Principal` em toda execucao e navegacao da bateria, abre a aba detalhada ao fim e gera CSV completo + CSV corretivo por execucao, com contexto semantico do catalogo
...
1. Importar a V12.0.0185 no Excel e validar `CT_IniciarBateria`, `CT2_ExecutarSmokeRapido` e `CT2_ExecutarStress`.
