...
operacional no corpo do quadro de servicos, dividido em `B29/B30`. Esse aviso e
informativo: mostra status, disponibilidade e contexto operacional sem alterar
fila, expiracao ou recusa. O antigo ponto `C16` fica limpo para nao competir com
o cabecalho do prestador. Na avaliacao, o diagnostico completo aparece no campo
`B40` Observacoes, que e o local legivel para texto longo.
