...
- Evidência final V204: `VR_20260511_175849` em
  `auditoria/evidencias/V12.0.0204/`.
- Débito V205 aceito: renomear a taxonomia pública de "Sexteto" para
  nomenclatura profissional de engenharia de software, sem alterar o contrato
  histórico da V204.
- Débito V205 aceito: simplificar a Central de Testes para que a validação
  completa de release seja a primeira opção clara para humanos.
