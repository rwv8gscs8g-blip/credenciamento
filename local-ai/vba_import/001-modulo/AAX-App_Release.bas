...
' V12.0.0204 ONDA 21 MD-21.6 (2026-05-06) - Svc_Transacao rejeita
' transacao aninhada sem sobrescrever a externa; Smoke cobre ATM_002.
' V12.0.0204 ONDA 22 MD-22.1 (2026-05-06) - Backfill explicito de
' DT_ULT_REATIV a partir de AUDIT_LOG; Smoke cobre MIG_005.
' V12.0.0204 ONDA 22 MD-22.2 (2026-05-06) - fecha INT-CAD-OS-REF-ORFA
' com diagnostico/migracao controlada de residuos sem chave em CAD_OS;
' Smoke cobre MIG_006 e IntegridadeBase fecha CS_INT_04 quando zerado.
' V12.0.0204 ONDA 22 MD-22.3 (2026-05-06) - DT_ULT_REATIV nao vazia
' e invalida bloqueia contagem punitiva de strikes; Smoke cobre MIG_007
' e IntegridadeBase cobre CS_INT_05.
' MICRO39-fix1 evita mutacao direta de EMPRESAS no MIG_007 e preserva erro fatal.
...
' V12.0.0206 ONDA 38.2.21 - Formularios residuais code-only:
' AvaliarOS resolve demandante por OS_ID quando avaliador vier vazio.
' V12.0.0206 ONDA 38.2.23 - Impressao residual code-only:
' corrige demandante IMP_AVALIA L9:P15, total visual EMITE_OS N63:P63
...
Public Const APP_BUILD_IMPORTADO As String = "10c1750+ONDA38.2.37-DISPONIBILIDADE-COMPOSTA"
Public Const APP_BUILD_BRANCH As String = "codex/v12-0-0206-planejamento"
Public Const APP_BUILD_GERADO_EM As String = "2026-06-08 23:48"
