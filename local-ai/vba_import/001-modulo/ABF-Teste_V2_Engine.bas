...
Private Sub TV2_GerarRoteiroAssistido()
    ...
    TV2_AddRoteiro ws, nr, "RELSSR_13_IMPRESSOS_AVISO_CORPO_OBSERVACOES", "AUTO", "Validar aviso no corpo", "Executar TV2_RunRelatoriosSuspensoesStrikesReset", "Pre-OS/OS usam B24; avaliacao usa Observacoes", "Linha RELSSR_13 no resultado", "Impede retorno do texto longo espremido no cabecalho", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "RELSSR_14_IMPRESSOS_LIMPEZA_AVISO_CORPO", "AUTO", "Validar limpeza de B24", "Executar TV2_RunRelatoriosSuspensoesStrikesReset", "LimparOS e LimparPREOS removem o aviso operacional de B24", "Linha RELSSR_14 no resultado", "Evita residuo visual entre impressoes", "AUTOMATIZADO"
