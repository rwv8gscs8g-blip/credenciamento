...
Private Const TV2_CONFIG_SNAPSHOT_COLS As Long = 15
...
Private gTV2ConfigSnapshot As Variant
Private gTV2ConfigSnapshotAtivo As Boolean
...
Private Sub TV2_ConfigSnapshotCapturar()
    Dim ws As Worksheet
    ...
    If Not ws Is Nothing Then
        gTV2ConfigSnapshot = ws.Range(ws.Cells(LINHA_CFG_VALORES, 1), ws.Cells(LINHA_CFG_VALORES, TV2_CONFIG_SNAPSHOT_COLS)).Value
        gTV2ConfigSnapshotAtivo = (Err.Number = 0)
    Else
        gTV2ConfigSnapshotAtivo = False
    End If
    Err.Clear
    On Error GoTo 0
End Sub

Private Sub TV2_ConfigSnapshotRestaurar()
    Dim ws As Worksheet
    ...
    On Error Resume Next
    Err.Clear
    If Not gTV2ConfigSnapshotAtivo Then Exit Sub

    Set ws = ThisWorkbook.Sheets(SHEET_CONFIG)
    If Not ws Is Nothing Then
        If Util_PrepararAbaParaEscrita(ws, estavaProtegida, senhaProtecao) Then
            ws.Range(ws.Cells(LINHA_CFG_VALORES, 1), ws.Cells(LINHA_CFG_VALORES, TV2_CONFIG_SNAPSHOT_COLS)).Value = gTV2ConfigSnapshot
...
Public Sub TV2_GerarCatalogoBase()
    ...
    TV2_AddCatalogo ws, nr, "SMK_007", "SMOKE", "RAPIDO", "AUTO", "Avaliacao", "Avaliar OS e concluir", "OS em execucao com notas validas", "Validar fechamento minimo da OS com auditoria e sem suspensao indevida", "OS concluida; auditoria registrada; empresa permanece ativa", "Fecha o ciclo core ponta a ponta com rastro mínimo", "AUTOMATIZADO_ATUAL", "Executado no smoke"
    ...
    TV2_AddCatalogo ws, nr, "TELAINI_01_ENTRADAS_CANONICAS", "TELA_INICIAL", "RAPIDO", "AUTO", "UI", "Entradas canonicas", "src/vba disponivel para leitura", "Validar Auto_Open, IniciarSistema e AbrirMenu delegando ao mesmo inicializador", "Tokens estruturais presentes", "Evita divergencia entre entrada automatica, macro manual e atalho visual", "AUTOMATIZADO_0206", "Executar TV2_RunTelaInicial"
    TV2_AddCatalogo ws, nr, "TELAINI_02_PROCESSOS_DE_ABERTURA", "TELA_INICIAL", "RAPIDO", "AUTO", "UI", "Processos de abertura", "Auto_Open no pacote fonte", "Validar CNAE, backfill e abertura do Menu_Principal", "Tokens estruturais presentes", "Garante que a tela inicial preserva processos operacionais no escopo importado", "AUTOMATIZADO_0206", "Executar TV2_RunTelaInicial"
    TV2_AddCatalogo ws, nr, "TELAINI_03_PROTECAO_DELEGADA_BL4", "TELA_INICIAL", "RAPIDO", "AUTO", "Protecao", "Protecao delegada a BL4", "Suite BL4 ja catalogada", "Validar que a cobertura de protecao de abertura continua no mapa V2 dedicado", "Tokens da suite BL4 presentes", "Evita acoplar Tela Inicial a Auto_Open fora do delta 0159", "AUTOMATIZADO_0206_FIX1", "Executar TV2_RunTelaInicial"
    TV2_AddCatalogo ws, nr, "TELAINI_04_ATALHO_VISUAL_INICIAR", "TELA_INICIAL", "RAPIDO", "AUTO", "UI", "Atalho visual Iniciar Sistema", "UX_IniciarSistema no pacote fonte", "Validar shape unico, OnAction e exclusao de abas criticas", "Tokens estruturais presentes", "Garante entrada visual sem mexer em Auto_Open", "AUTOMATIZADO_0206", "Executar TV2_RunTelaInicial"
    TV2_AddCatalogo ws, nr, "TELAINI_05_INICIALIZACAO_PAGINA_ZERO", "TELA_INICIAL", "RAPIDO", "AUTO", "UI", "Inicializacao na pagina zero", "Menu_Principal no pacote fonte", "Validar carga de listas, chamada Tela_Inicial e abas ocultas", "Tokens estruturais presentes", "Evita abrir em pagina residual ou sem dados basicos", "AUTOMATIZADO_0206", "Executar TV2_RunTelaInicial"
    TV2_AddCatalogo ws, nr, "TELAINI_06_HOME_ESTADO_VISUAL", "TELA_INICIAL", "RAPIDO", "AUTO", "UI", "Home retorna ao inicio", "Menu_Principal no pacote fonte", "Validar Home ativo, rotas transparentes e PAGINAS=0", "Tokens estruturais presentes", "Garante retorno previsivel ao painel inicial", "AUTOMATIZADO_0206", "Executar TV2_RunTelaInicial"
    TV2_AddCatalogo ws, nr, "TELAINI_07_SOBRE_RELEASE_REGRA", "TELA_INICIAL", "RAPIDO", "AUTO", "UI", "Sobre com release e regra", "Menu_Principal no pacote fonte", "Validar campos App_Release e MsgBox Sobre", "Tokens estruturais presentes", "Permite conferir versao e objetivo sem mutar dados", "AUTOMATIZADO_0206", "Executar TV2_RunTelaInicial"
    TV2_AddCatalogo ws, nr, "TELAINI_08_GITHUB_FALLBACK_URL", "TELA_INICIAL", "RAPIDO", "AUTO", "UI", "GitHub com fallback", "Menu_Principal no pacote fonte", "Validar Shell open no Mac, Windows e hyperlinks fallback", "Tokens estruturais presentes", "Evita travamento ao abrir repositorio no Mac", "AUTOMATIZADO_0206", "Executar TV2_RunTelaInicial"
    TV2_AddCatalogo ws, nr, "TELAINI_09_CENTRAL_TESTES_GUARD", "TELA_INICIAL", "RAPIDO", "AUTO", "UI", "Central com confirmacao", "Menu_Principal no pacote fonte", "Validar alerta de treinamento, recolhimento do menu e chamada CT_AbrirCentral", "Tokens estruturais presentes", "Impede entrar em fluxo que altera dados sem confirmacao humana", "AUTOMATIZADO_0206", "Executar TV2_RunTelaInicial"
    TV2_AddCatalogo ws, nr, "TELAINI_10_CENTRAL_OPCOES", "TELA_INICIAL", "RAPIDO", "AUTO", "UI", "Opcoes da Central", "Central_Testes no pacote fonte", "Validar VCR, Central V2 e Bateria Oficial no menu", "Tokens estruturais presentes", "Mapeia o que o botao Central pode disparar", "AUTOMATIZADO_0206", "Executar TV2_RunTelaInicial"
    TV2_AddCatalogo ws, nr, "TELAINI_11_CONFIGURACOES_MODAL", "TELA_INICIAL", "RAPIDO", "AUTO", "UI", "Configuracoes modal", "Menu_Principal no pacote fonte", "Validar descarte de instancia antiga e Show vbModal", "Tokens estruturais presentes", "Preserva entrada validada para Configuracoes Iniciais", "AUTOMATIZADO_0206", "Executar TV2_RunTelaInicial"
    TV2_AddCatalogo ws, nr, "TELAINI_12_ROTAS_LATERAIS", "TELA_INICIAL", "RAPIDO", "AUTO", "UI", "Rotas laterais", "Menu_Principal no pacote fonte", "Validar paginas 1 a 7 do menu lateral", "Tokens estruturais presentes", "Mantem a Tela Inicial conectada ao fluxo real do operador", "AUTOMATIZADO_0206", "Executar TV2_RunTelaInicial"
    TV2_AddCatalogo ws, nr, "TELAINI_13_SAIR_CONFIRMA_SEM_SAVE", "TELA_INICIAL", "RAPIDO", "AUTO", "UI", "Sair com confirmacao", "Menu_Principal no pacote fonte", "Validar pergunta de fechamento e close sem savechanges", "Tokens estruturais presentes", "Evita confundir fechamento com persistencia", "AUTOMATIZADO_0206", "Executar TV2_RunTelaInicial"
    TV2_AddCatalogo ws, nr, "TELAINI_14_X_NAO_BLOQUEADO", "TELA_INICIAL", "RAPIDO", "AUTO", "UI", "X nao bloqueado", "Menu_Principal no pacote fonte", "Validar ausencia de QueryClose com Cancel=True", "Token proibido ausente", "Garante saida visual padrao alem do comando Sair", "AUTOMATIZADO_0206", "Executar TV2_RunTelaInicial"
    TV2_AddCatalogo ws, nr, "REL_TELA_01_HELPERS_STATUS_HUMANO", "TELA_RELATORIOS", "RAPIDO", "AUTO", "Relatorios", "Helpers de status humano", "Rel_Rodizio_Status no pacote fonte", "Validar funcoes publicas para status, suspensao e disponibilidade", "Tokens estruturais presentes", "Evita repetir interpretacao de suspensao em cada relatorio", "AUTOMATIZADO_0206", "Executar TV2_RunTelaRelatorios"
    TV2_AddCatalogo ws, nr, "REL_TELA_02_EMPRESA_POR_SERVICO_NOME_SERVICO", "TELA_RELATORIOS", "RAPIDO", "AUTO", "Relatorios", "Empresa por servico com nome", "Rel_Emp_Serv no pacote fonte", "Validar cabecalho com atividade, servico e status da empresa", "Tokens estruturais presentes", "Fecha a lacuna visual do relatorio Empresa credenciada por servico", "AUTOMATIZADO_0206", "Executar TV2_RunTelaRelatorios"
    TV2_AddCatalogo ws, nr, "REL_TELA_03_OS_POR_EMPRESA_DATAS_STATUS", "TELA_RELATORIOS", "RAPIDO", "AUTO", "Relatorios", "OS por empresa com datas", "Rel_OSEmpresa no pacote fonte", "Validar resumo com status, suspensa desde/ate e ultima reativacao", "Tokens estruturais presentes", "Permite ler historico operacional sem abrir a base", "AUTOMATIZADO_0206", "Executar TV2_RunTelaRelatorios"
    TV2_AddCatalogo ws, nr, "REL_TELA_04_ENTIDADES_FORMATACAO_PADRAO", "TELA_RELATORIOS", "RAPIDO", "AUTO", "Relatorios", "Entidades formatadas", "Menu_Principal no pacote fonte", "Validar uso dos helpers de cabecalho/dados no relatorio de entidades", "Tokens estruturais presentes", "Alinha relatorios sem empresa ao padrao visual aprovado", "AUTOMATIZADO_0206", "Executar TV2_RunTelaRelatorios"
    TV2_AddCatalogo ws, nr, "REL_TELA_05_EMPRESAS_CADASTRADAS_STATUS", "TELA_RELATORIOS", "RAPIDO", "AUTO", "Relatorios", "Empresas cadastradas com status", "Menu_Principal no pacote fonte", "Validar colunas de status e datas de suspensao", "Tokens estruturais presentes", "Garante que listagem geral nao omite bloqueio operacional", "AUTOMATIZADO_0206", "Executar TV2_RunTelaRelatorios"
    TV2_AddCatalogo ws, nr, "REL_TELA_06_EMPRESAS_CREDENCIADAS_STATUS", "TELA_RELATORIOS", "RAPIDO", "AUTO", "Relatorios", "Empresas credenciadas com status", "Menu_Principal no pacote fonte", "Validar status de credenciamento, status global e disponibilidade", "Tokens estruturais presentes", "Evita confundir credenciamento ativo com empresa apta", "AUTOMATIZADO_0206", "Executar TV2_RunTelaRelatorios"
    TV2_AddCatalogo ws, nr, "REL_TELA_07_OS_ABERTAS_STATUS", "TELA_RELATORIOS", "RAPIDO", "AUTO", "Relatorios", "OS abertas com status", "Menu_Principal no pacote fonte", "Validar status e datas de suspensao em cada OS aberta", "Tokens estruturais presentes", "Permite decidir sobre execucao pendente com status visivel", "AUTOMATIZADO_0206", "Executar TV2_RunTelaRelatorios"
    TV2_AddCatalogo ws, nr, "REL_TELA_08_PREOS_VENCIDAS_STATUS", "TELA_RELATORIOS", "RAPIDO", "AUTO", "Relatorios", "Pre-OS vencidas com status", "Menu_Principal no pacote fonte", "Validar status e datas de suspensao em cada pre-OS vencida", "Tokens estruturais presentes", "Evita avaliar atraso sem saber se a empresa esta suspensa", "AUTOMATIZADO_0206", "Executar TV2_RunTelaRelatorios"
    TV2_AddCatalogo ws, nr, "REL_TELA_09_LIMPEZA_RELATORIO_TEMPORARIO", "TELA_RELATORIOS", "RAPIDO", "AUTO", "Relatorios", "Limpeza da aba temporaria", "Menu_Principal no pacote fonte", "Validar limpeza de conteudo e area de impressao apos sucesso ou erro", "Tokens estruturais presentes", "Evita resquicio visual ou area de impressao velha", "AUTOMATIZADO_0206", "Executar TV2_RunTelaRelatorios"
    TV2_AddCatalogo ws, nr, "REL_TELA_10_STATUS_RODIZIO_POR_SERVICO_FORMATADO", "TELA_RELATORIOS", "RAPIDO", "AUTO", "Relatorios", "Status do rodizio por servico", "Rel_Rodizio_Status no pacote fonte", "Validar retorno consolidado, suspensas, proximo retorno e formatacao", "Tokens estruturais presentes", "Complementa relatorios humanos com diagnostico operacional", "AUTOMATIZADO_0206", "Executar TV2_RunTelaRelatorios"
    TV2_AddCatalogo ws, nr, "REL_TELA_11_PREOS_VENCIDAS_IMPRESSAO_SEM_EXPIRAR", "TELA_RELATORIOS", "RAPIDO", "AUTO", "Relatorios", "Pre-OS vencidas sem expiracao automatica", "Menu_Principal no pacote fonte", "Validar que o relatorio imprime pendencias vencidas sem chamar expiracao, recusa ou avanco de fila", "Trecho do botao possui tokens obrigatorios e nao possui tokens destrutivos", "Documenta que consulta/impressao nao substitui decisao manual de expirar", "AUTOMATIZADO_0206", "Executar TV2_RunTelaRelatorios"
    TV2_AddCatalogo ws, nr, "RELSSR_01_HELPER_RESUMO_STRIKES", "REL_SUSP_STRIKES_RESET", "RAPIDO", "AUTO", "Relatorios", "Helpers de strikes", "Rel_Rodizio_Status no pacote fonte", "Validar helpers para strikes por nota baixa, recusa/prazo e fallback de auditoria", "Tokens estruturais presentes", "Evita divergencia visual apos iniciar novo periodo preservando suspensao", "AUTOMATIZADO_0206", "Executar TV2_RunRelatoriosSuspensoesStrikesReset"
    TV2_AddCatalogo ws, nr, "RELSSR_02_EMPRESAS_CADASTRADAS_STRIKES", "REL_SUSP_STRIKES_RESET", "RAPIDO", "AUTO", "Relatorios", "Empresas cadastradas com strikes", "Menu_Principal no pacote fonte", "Validar colunas de strikes e diagnostico na listagem geral", "Tokens estruturais presentes", "Empresa suspensa fica legivel no relatorio geral", "AUTOMATIZADO_0206", "Executar TV2_RunRelatoriosSuspensoesStrikesReset"
    TV2_AddCatalogo ws, nr, "RELSSR_03_EMPRESAS_CREDENCIADAS_STRIKES", "REL_SUSP_STRIKES_RESET", "RAPIDO", "AUTO", "Relatorios", "Empresas credenciadas com disponibilidade", "Menu_Principal no pacote fonte", "Validar status global, status de credenciamento, disponibilidade e strikes", "Tokens estruturais presentes", "Evita confundir credenciamento ativo com aptidao operacional", "AUTOMATIZADO_0206", "Executar TV2_RunRelatoriosSuspensoesStrikesReset"
    TV2_AddCatalogo ws, nr, "RELSSR_04_OS_ABERTAS_SEM_FANTASMA", "REL_SUSP_STRIKES_RESET", "RAPIDO", "AUTO", "Relatorios", "OS abertas sem N.O.S. zero", "Menu_Principal no pacote fonte", "Validar que linhas sem OS real nao imprimem empresa nao encontrada", "Tokens estruturais presentes", "Remove falso positivo observado no PDF 058", "AUTOMATIZADO_0206", "Executar TV2_RunRelatoriosSuspensoesStrikesReset"
    TV2_AddCatalogo ws, nr, "RELSSR_05_PREOS_VENCIDAS_STRIKES", "REL_SUSP_STRIKES_RESET", "RAPIDO", "AUTO", "Relatorios", "Pre-OS vencidas com strikes", "Menu_Principal no pacote fonte", "Validar diagnostico operacional em cada pre-OS vencida", "Tokens estruturais presentes", "Atraso fica auditavel junto da condicao da empresa", "AUTOMATIZADO_0206", "Executar TV2_RunRelatoriosSuspensoesStrikesReset"
    TV2_AddCatalogo ws, nr, "RELSSR_06_EMPRESA_POR_SERVICO_STRIKES", "REL_SUSP_STRIKES_RESET", "RAPIDO", "AUTO", "Relatorios", "Empresa por servico com disponibilidade", "Rel_Emp_Serv no pacote fonte", "Validar nome do servico, status, disponibilidade e strikes por empresa", "Tokens estruturais presentes", "Fecha divergencia entre relatorios com e sem status", "AUTOMATIZADO_0206", "Executar TV2_RunRelatoriosSuspensoesStrikesReset"
    TV2_AddCatalogo ws, nr, "RELSSR_07_OS_POR_EMPRESA_STRIKES", "REL_SUSP_STRIKES_RESET", "RAPIDO", "AUTO", "Relatorios", "OS por empresa com strikes", "Rel_OSEmpresa no pacote fonte", "Validar resumo superior com status, retorno e strikes", "Tokens estruturais presentes", "Permite auditar OS com a situacao operacional visivel", "AUTOMATIZADO_0206", "Executar TV2_RunRelatoriosSuspensoesStrikesReset"
    TV2_AddCatalogo ws, nr, "RELSSR_08_IMPRESSOS_AVISO_OPERACIONAL", "REL_SUSP_STRIKES_RESET", "RAPIDO", "AUTO", "Impressao", "Aviso operacional em documentos", "Preencher no pacote fonte", "Validar status da empresa nesta data nos impressos de Pre-OS, OS e avaliacao", "Tokens estruturais presentes", "Facilita auditoria humana dos documentos impressos", "AUTOMATIZADO_0206", "Executar TV2_RunRelatoriosSuspensoesStrikesReset"
    TV2_AddCatalogo ws, nr, "RELSSR_09_CONTRATO_NOVO_PERIODO_PRESERVA_SUSPENSAO", "REL_SUSP_STRIKES_RESET", "RAPIDO", "AUTO", "Novo Periodo", "Preservacao de suspensao", "Configuracao_Inicial no pacote fonte", "Validar que Novo Periodo limpa PRE_OS/CAD_OS e preserva cadastros", "Tokens estruturais presentes", "Documenta passagem de ano sem anistia operacional", "AUTOMATIZADO_0206", "Executar TV2_RunRelatoriosSuspensoesStrikesReset"
    TV2_AddCatalogo ws, nr, "RELSSR_10_CONTRATO_LIMPAR_BASE_REMOVE_SUSPENSAO", "REL_SUSP_STRIKES_RESET", "RAPIDO", "AUTO", "Limpar Base", "Reset total remove suspensoes", "Mod_Limpeza_Base no pacote fonte", "Validar que Limpar Base apaga empresas, credenciamentos e auditoria", "Tokens estruturais presentes", "Documenta uso correto para iniciar outro municipio", "AUTOMATIZADO_0206", "Executar TV2_RunRelatoriosSuspensoesStrikesReset"
    TV2_AddCatalogo ws, nr, "RELSSR_11_IMPRESSOS_C16_LIMPO", "REL_SUSP_STRIKES_RESET", "RAPIDO", "AUTO", "Impressao", "C16 limpo", "Preencher no pacote fonte", "Validar que C16 deixa de carregar aviso operacional nos impressos", "C16:N16 e limpo e permanece sem ShrinkToFit", "Evita frase comprimida no cabecalho dos PDFs", "AUTOMATIZADO_0206", "Executar TV2_RunRelatoriosSuspensoesStrikesReset"
    TV2_AddCatalogo ws, nr, "RELSSR_12_DISPONIBILIDADE_COMPOSTA_SUSPENSAO", "REL_SUSP_STRIKES_RESET", "RAPIDO", "AUTO", "Relatorios", "Suspensao com ocupacao", "Rel_Rodizio_Status no pacote fonte", "Validar que disponibilidade de empresa suspensa tambem mostra OS aberta ou Pre-OS pendente na atividade", "Tokens estruturais de composicao presentes", "Evita ocultar ocupacao adicional em relatorios e avisos", "AUTOMATIZADO_0206", "Executar TV2_RunRelatoriosSuspensoesStrikesReset"
    TV2_AddCatalogo ws, nr, "RELSSR_13_IMPRESSOS_AVISO_CORPO_OBSERVACOES", "REL_SUSP_STRIKES_RESET", "RAPIDO", "AUTO", "Impressao", "Aviso no corpo/observacoes", "Preencher no pacote fonte", "Validar que Pre-OS/OS usam B29/B30 e avaliacao usa Observacoes", "Tokens estruturais presentes e ShrinkToFit desativado", "Evita comprimir texto longo ate ficar ilegivel", "AUTOMATIZADO_0206", "Executar TV2_RunRelatoriosSuspensoesStrikesReset"
    TV2_AddCatalogo ws, nr, "RELSSR_14_IMPRESSOS_LIMPEZA_AVISO_CORPO", "REL_SUSP_STRIKES_RESET", "RAPIDO", "AUTO", "Impressao", "Limpeza do aviso", "Preencher no pacote fonte", "Validar que LimparOS e LimparPREOS removem aviso de B24, B29 e B30", "Tokens estruturais presentes", "Evita residuo visual entre impressoes sucessivas", "AUTOMATIZADO_0206", "Executar TV2_RunRelatoriosSuspensoesStrikesReset"
    TV2_AddCatalogo ws, nr, "RELSSR_15_IMPRESSOS_AVISO_RODAPE_LEGIVEL", "REL_SUSP_STRIKES_RESET", "RAPIDO", "AUTO", "Impressao", "Aviso no rodape do quadro", "Preencher no pacote fonte", "Validar que o aviso operacional usa B29:K30 com fonte reduzida", "Tokens estruturais presentes", "Evita que o texto encoste nas bordas do PDF", "AUTOMATIZADO_0206", "Executar TV2_RunRelatoriosSuspensoesStrikesReset"
    TV2_AddCatalogo ws, nr, "RELSSR_16_RELATORIOS_LARGURA_UTIL", "REL_SUSP_STRIKES_RESET", "RAPIDO", "AUTO", "Relatorios", "Largura util de impressao", "Util_Config no pacote fonte", "Validar area de impressao com zoom dinamico no helper comum dos relatorios", "Tokens estruturais presentes", "Reduz vazio lateral e melhora leitura dos relatorios", "AUTOMATIZADO_0206", "Executar TV2_RunRelatoriosSuspensoesStrikesReset"
    TV2_AddCatalogo ws, nr, "CFGCSV_01_CONTROLES_TODOS_CAMPOS", "CONFIG_CENARIOS_CSV", "DESTRUTIVO", "AUTO", "Config", "Controles de persistencia", "Formulario Configuracao_Inicial carregavel", "Validar todos os controles usados pela matriz", "Gestor, municipio, prazo, recusas, dias, nota e strikes existem", "Impede mapa de teste parcial sobre campo ausente", "AUTOMATIZADO_0206", "Executar TV2_RunConfigCenariosNovoPeriodo em base de homologacao"
    TV2_AddCatalogo ws, nr, "CFGCSV_02_CENARIO_1_ROUNDTRIP", "CONFIG_CENARIOS_CSV", "DESTRUTIVO", "AUTO", "Config", "Round-trip valores 1", "Hearback 0160 autorizou teste destrutivo", "Persistir matriz minima positiva pela UI", "CONFIG e getters retornam 1 nos campos numericos e textos com build", "Cobre borda minima dos parametros de negocio", "AUTOMATIZADO_0206", "CSV gerado na pasta V12-0-0206-Onda-38-2-30"
    TV2_AddCatalogo ws, nr, "CFGCSV_03_CENARIO_2_ROUNDTRIP", "CONFIG_CENARIOS_CSV", "DESTRUTIVO", "AUTO", "Config", "Round-trip valores 2", "CEN1 ja executado", "Persistir variacao maior que 1 pela UI", "CONFIG e getters retornam 2 nos campos numericos e textos com build", "Cobre alteracao real de todos os parametros variaveis", "AUTOMATIZADO_0206", "CSV gerado na pasta V12-0-0206-Onda-38-2-30"
    TV2_AddCatalogo ws, nr, "CFGCSV_04_REGRA_RECUSA_DIAS", "CONFIG_CENARIOS_CSV", "DESTRUTIVO", "AUTO", "Rodizio", "Recusa consome configuracao", "MAX_RECUSAS=1 e DIAS_RECUSA_PRAZO=1 persistidos pela UI", "Executar recusa controlada de Pre-OS", "Empresa suspende por 1 dia", "Prova que a persistencia chega ao fluxo de rodizio", "AUTOMATIZADO_0206", "Suite limpa PRE_OS/CAD_OS ao final pelo Novo Periodo"
    TV2_AddCatalogo ws, nr, "CFGCSV_05_REGRA_STRIKE_DIAS", "CONFIG_CENARIOS_CSV", "DESTRUTIVO", "AUTO", "Avaliacao", "Strike consome configuracao", "MAX_STRIKES=2, NOTA_MINIMA=2 e DIAS_STRIKE=2 persistidos pela UI", "Executar duas avaliacoes baixas controladas", "Empresa suspende por 2 dias", "Prova que nota, strikes e dias chegam ao servico de avaliacao", "AUTOMATIZADO_0206", "Suite gera CSV para validacao humana"
    TV2_AddCatalogo ws, nr, "CFGCSV_06_NOVO_PERIODO_COPIA_LIMPEZA", "CONFIG_CENARIOS_CSV", "DESTRUTIVO", "AUTO", "Novo Periodo", "Copia e limpeza deterministica", "Cenarios ja geraram dados em PRE_OS/CAD_OS", "Criar pasta V12-0-0206-Onda-38-2-30, salvar copia e limpar PRE_OS/CAD_OS", "Copia da planilha existe; PRE_OS=0; CAD_OS=0", "Fecha prototipo de testador de cenarios com salvaguarda antes da limpeza", "AUTOMATIZADO_0206", "Nao executar em base de producao"
    TV2_AddCatalogo ws, nr, "CFGCSV_07_CSV_EVIDENCIA", "CONFIG_CENARIOS_CSV", "DESTRUTIVO", "AUTO", "Evidencia", "CSV junto da copia", "Pasta de Novo Periodo criada", "Salvar CSV com ordem, fila, valores e resultados", "CSV existe na pasta do Novo Periodo", "Permite validacao humana enquanto PDF nao existe", "AUTOMATIZADO_0206", "Arquivo TesteV2_CONFIG_CENARIOS_<execucao>.csv"
    ...
    TV2_AddCatalogo ws, nr, "UI_ADV_010_CENTRAL_V2_EXPOE_SUITE", "ADVERSARIAL_UI", "RAPIDO", "AUTO", "UI", "Central V2 expoe Adversarial UI", "Central_Testes_V2 no pacote fonte", "Validar wrapper, texto de menu da nova suite e entrada RVS", "Tokens estruturais presentes no modulo", "Garante que a suite nao fique escondida no VBE", "AUTOMATIZADO_0204", "Executado na suite Adversarial UI"
...
Private Function TV2_ConfigValorOperadorOuCanonico(ByVal valorAtual As Variant, ByVal valorCanonico As String) As String
    Dim texto As String

    On Error Resume Next
    texto = Trim$(CStr(valorAtual))
    If Err.Number <> 0 Then
        Err.Clear
        texto = ""
    End If
    ...
    If texto <> "" Then
        TV2_ConfigValorOperadorOuCanonico = texto
    Else
        TV2_ConfigValorOperadorOuCanonico = valorCanonico
    End If
End Function
...
Private Sub TV2_SetConfigCanonica()
    ...
    ws.Cells(LINHA_CFG_VALORES, COL_CFG_GESTOR).Value = TV2_ConfigValorOperadorOuCanonico(ws.Cells(LINHA_CFG_VALORES, COL_CFG_GESTOR).Value, "Gestor Testes V2")
    ws.Cells(LINHA_CFG_VALORES, COL_CFG_LOGO).Value = "LOGO_TESTES_V2"
    ws.Cells(LINHA_CFG_VALORES, COL_CFG_MUNICIPIO).Value = TV2_ConfigValorOperadorOuCanonico(ws.Cells(LINHA_CFG_VALORES, COL_CFG_MUNICIPIO).Value, "Municipio de Testes V2")
    ...
    ' V12.0.0206: DIAS_SUSPENSAO_STRIKE=30 elimina o fallback historico
    ' em meses; suites que precisam de outros prazos sobrescrevem localmente.
...
Private Sub TV2_GerarRoteiroAssistido()
    ...
    TV2_AddRoteiro ws, nr, "SMK_007", "AUTO", "Validar conclusão de OS sem suspensão indevida", "Apenas conferir o resultado automatizado do cenario", "Avaliação bem-sucedida; STATUS_OS=CONCLUIDA; auditoria mínima presente; empresa segue ativa", "Linha do cenario SMK_007", "Fecha o ciclo ponta a ponta com evidência mínima", "AUTOMATIZADO"
    ...
    TV2_AddRoteiro ws, nr, "TELAINI_01_ENTRADAS_CANONICAS", "AUTO", "Validar entradas da Tela Inicial", "Executar TV2_RunTelaInicial", "Auto_Open, IniciarSistema e AbrirMenu convergem", "Linha TELAINI_01 no resultado", "Evita divergencia entre formas de abrir o sistema", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "TELAINI_02_PROCESSOS_DE_ABERTURA", "AUTO", "Validar processos de abertura", "Executar TV2_RunTelaInicial", "CNAE, backfill e Menu_Principal encadeados", "Linha TELAINI_02 no resultado", "Garante abertura operacional no escopo importado", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "TELAINI_03_PROTECAO_DELEGADA_BL4", "AUTO", "Validar cobertura BL4 relacionada", "Executar TV2_RunTelaInicial", "Suite BL4 de protecao de abertura permanece mapeada", "Linha TELAINI_03 no resultado", "Mantem protecao auditavel em suite propria", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "TELAINI_04_ATALHO_VISUAL_INICIAR", "AUTO", "Validar atalho visual Iniciar Sistema", "Executar TV2_RunTelaInicial", "Shape chama IniciarSistema e evita abas criticas", "Linha TELAINI_04 no resultado", "Garante entrada visual sem alterar UserForms", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "TELAINI_05_INICIALIZACAO_PAGINA_ZERO", "AUTO", "Validar inicializacao do Menu_Principal", "Executar TV2_RunTelaInicial", "UserForm carrega listas e chama Tela_Inicial", "Linha TELAINI_05 no resultado", "Evita pagina residual na abertura", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "TELAINI_06_HOME_ESTADO_VISUAL", "AUTO", "Validar comando Inicio", "Executar TV2_RunTelaInicial", "Home volta para PAGINAS=0", "Linha TELAINI_06 no resultado", "Garante retorno previsivel ao painel inicial", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "TELAINI_07_SOBRE_RELEASE_REGRA", "AUTO", "Validar botao Sobre", "Executar TV2_RunTelaInicial", "Sobre usa App_Release e mostra MsgBox informativo", "Linha TELAINI_07 no resultado", "Permite conferir build e objetivo sem mutar dados", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "TELAINI_08_GITHUB_FALLBACK_URL", "AUTO", "Validar botao GitHub", "Executar TV2_RunTelaInicial", "URL oficial abre com fallback Mac/Windows", "Linha TELAINI_08 no resultado", "Evita travamento e preserva caminho manual", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "TELAINI_09_CENTRAL_TESTES_GUARD", "AUTO", "Validar guard da Central de Testes", "Executar TV2_RunTelaInicial", "Aviso de treinamento e confirmacao antes da Central", "Linha TELAINI_09 no resultado", "Protege base real contra entrada acidental em treinamento", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "TELAINI_10_CENTRAL_OPCOES", "AUTO", "Validar opcoes da Central", "Executar TV2_RunTelaInicial", "VCR, V2 e Bateria Oficial continuam expostos", "Linha TELAINI_10 no resultado", "Mapeia processos disparados pela tela inicial", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "TELAINI_11_CONFIGURACOES_MODAL", "AUTO", "Validar atalho Configuracoes Iniciais", "Executar TV2_RunTelaInicial", "Formulario abre em Show vbModal apos descarte de instancia antiga", "Linha TELAINI_11 no resultado", "Preserva fluxo validado na onda anterior", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "TELAINI_12_ROTAS_LATERAIS", "AUTO", "Validar rotas laterais", "Executar TV2_RunTelaInicial", "Paginas 1 a 7 continuam mapeadas", "Linha TELAINI_12 no resultado", "Mantem Tela Inicial integrada ao sistema", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "TELAINI_13_SAIR_CONFIRMA_SEM_SAVE", "AUTO", "Validar contrato do comando Sair", "Executar TV2_RunTelaInicial", "Sair confirma e fecha sem savechanges", "Linha TELAINI_13 no resultado", "Evita tratar fechamento como salvamento", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "TELAINI_14_X_NAO_BLOQUEADO", "AUTO", "Validar fechamento pelo X", "Executar TV2_RunTelaInicial", "Menu_Principal nao bloqueia QueryClose", "Linha TELAINI_14 no resultado", "Garante saida visual padrao", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "REL_TELA_01_HELPERS_STATUS_HUMANO", "AUTO", "Validar helpers de status dos relatorios", "Executar TV2_RunTelaRelatorios", "Funcoes publicas de status e datas presentes", "Linha REL_TELA_01 no resultado", "Centraliza leitura humana da suspensao", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "REL_TELA_02_EMPRESA_POR_SERVICO_NOME_SERVICO", "AUTO", "Validar Empresa por servico", "Executar TV2_RunTelaRelatorios", "Relatorio mostra atividade, servico, status e disponibilidade", "Linha REL_TELA_02 no resultado", "Fecha nome do servico no relatorio solicitado", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "REL_TELA_03_OS_POR_EMPRESA_DATAS_STATUS", "AUTO", "Validar OS por empresa", "Executar TV2_RunTelaRelatorios", "Resumo mostra status, suspensao e reativacao", "Linha REL_TELA_03 no resultado", "Torna historico operacional legivel", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "REL_TELA_04_ENTIDADES_FORMATACAO_PADRAO", "AUTO", "Validar formatacao de entidades", "Executar TV2_RunTelaRelatorios", "Relatorio usa cabecalho, linhas alternadas e bordas", "Linha REL_TELA_04 no resultado", "Propaga o padrao visual aprovado", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "REL_TELA_05_EMPRESAS_CADASTRADAS_STATUS", "AUTO", "Validar empresas cadastradas", "Executar TV2_RunTelaRelatorios", "Colunas de status e datas de suspensao presentes", "Linha REL_TELA_05 no resultado", "Listagem geral mostra bloqueio operacional", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "REL_TELA_06_EMPRESAS_CREDENCIADAS_STATUS", "AUTO", "Validar empresas credenciadas", "Executar TV2_RunTelaRelatorios", "Status do credenciamento, status global e disponibilidade presentes", "Linha REL_TELA_06 no resultado", "Separa credenciamento ativo de aptidao real", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "REL_TELA_07_OS_ABERTAS_STATUS", "AUTO", "Validar OS abertas", "Executar TV2_RunTelaRelatorios", "OS abertas trazem status, suspensa desde/ate e rodizio", "Linha REL_TELA_07 no resultado", "Operador ve risco antes de acompanhar execucao", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "REL_TELA_08_PREOS_VENCIDAS_STATUS", "AUTO", "Validar pre-OS vencidas", "Executar TV2_RunTelaRelatorios", "Pre-OS vencidas trazem status, suspensa desde/ate e rodizio", "Linha REL_TELA_08 no resultado", "Atraso fica contextualizado pela situacao da empresa", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "REL_TELA_09_LIMPEZA_RELATORIO_TEMPORARIO", "AUTO", "Validar limpeza da aba RELATORIO", "Executar TV2_RunTelaRelatorios", "Relatorios limpam conteudo e area de impressao nos caminhos principais", "Linha REL_TELA_09 no resultado", "Evita resquicio de relatorio anterior", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "REL_TELA_10_STATUS_RODIZIO_POR_SERVICO_FORMATADO", "AUTO", "Validar status por servico", "Executar TV2_RunTelaRelatorios", "Relatorio consolidado por servico mostra suspensas e proximo retorno", "Linha REL_TELA_10 no resultado", "Complementa a revisao tela a tela com diagnostico por servico", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "REL_TELA_11_PREOS_VENCIDAS_IMPRESSAO_SEM_EXPIRAR", "AUTO", "Validar Pre-OS vencidas sem expiracao automatica", "Executar TV2_RunTelaRelatorios", "Relatorio filtra pendencias vencidas, configura impressao e nao chama expiracao/recusa/avanco de fila", "Linha REL_TELA_11 no resultado", "Operador imprime pendencias e depois decide manualmente expirar", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "RELSSR_01_HELPER_RESUMO_STRIKES", "AUTO", "Validar helpers de strikes", "Executar TV2_RunRelatoriosSuspensoesStrikesReset", "Helpers leem nota baixa, recusa/prazo e fallback de auditoria", "Linha RELSSR_01 no resultado", "Evita divergencia visual apos novo periodo", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "RELSSR_02_EMPRESAS_CADASTRADAS_STRIKES", "AUTO", "Validar empresas cadastradas com strikes", "Executar TV2_RunRelatoriosSuspensoesStrikesReset", "Listagem geral mostra status, strikes e diagnostico", "Linha RELSSR_02 no resultado", "Empresa suspensa fica legivel no relatorio geral", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "RELSSR_03_EMPRESAS_CREDENCIADAS_STRIKES", "AUTO", "Validar empresas credenciadas com disponibilidade", "Executar TV2_RunRelatoriosSuspensoesStrikesReset", "Credenciamento, status global, disponibilidade e strikes aparecem juntos", "Linha RELSSR_03 no resultado", "Evita confundir credenciamento ativo com aptidao real", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "RELSSR_04_OS_ABERTAS_SEM_FANTASMA", "AUTO", "Validar OS abertas sem linha fantasma", "Executar TV2_RunRelatoriosSuspensoesStrikesReset", "N.O.S. vazio ou zero e ignorado", "Linha RELSSR_04 no resultado", "Remove falso positivo observado no PDF 058", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "RELSSR_05_PREOS_VENCIDAS_STRIKES", "AUTO", "Validar pre-OS vencidas com strikes", "Executar TV2_RunRelatoriosSuspensoesStrikesReset", "Pre-OS vencida traz status, disponibilidade, strikes e diagnostico", "Linha RELSSR_05 no resultado", "Atraso fica auditavel junto da condicao operacional", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "RELSSR_06_EMPRESA_POR_SERVICO_STRIKES", "AUTO", "Validar Empresa por servico com disponibilidade", "Executar TV2_RunRelatoriosSuspensoesStrikesReset", "Relatorio mostra servico, status, disponibilidade, strikes e diagnostico", "Linha RELSSR_06 no resultado", "Normaliza o relatorio usado como referencia visual", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "RELSSR_07_OS_POR_EMPRESA_STRIKES", "AUTO", "Validar OS por empresa com strikes", "Executar TV2_RunRelatoriosSuspensoesStrikesReset", "Resumo superior mostra status, retorno, disponibilidade e strikes", "Linha RELSSR_07 no resultado", "Auditoria das OS parte da situacao operacional correta", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "RELSSR_08_IMPRESSOS_AVISO_OPERACIONAL", "AUTO", "Validar aviso nos impressos", "Executar TV2_RunRelatoriosSuspensoesStrikesReset", "Pre-OS, OS e avaliacao recebem status da empresa nesta data", "Linha RELSSR_08 no resultado", "Facilita leitura humana dos documentos impressos", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "RELSSR_09_CONTRATO_NOVO_PERIODO_PRESERVA_SUSPENSAO", "AUTO", "Validar contrato de Novo Periodo", "Executar TV2_RunRelatoriosSuspensoesStrikesReset", "Novo Periodo limpa PRE_OS/CAD_OS e preserva cadastros", "Linha RELSSR_09 no resultado", "Passagem de ano preserva suspensoes existentes", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "RELSSR_10_CONTRATO_LIMPAR_BASE_REMOVE_SUSPENSAO", "AUTO", "Validar contrato de Limpar Base", "Executar TV2_RunRelatoriosSuspensoesStrikesReset", "Limpar Base apaga empresas, credenciamentos, operacao e auditoria", "Linha RELSSR_10 no resultado", "Novo municipio comeca sem suspensoes residuais", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "RELSSR_11_IMPRESSOS_C16_LIMPO", "AUTO", "Validar C16 limpo", "Executar TV2_RunRelatoriosSuspensoesStrikesReset", "C16 nao recebe mais aviso operacional", "Linha RELSSR_11 no resultado", "Evita frase comprimida no cabecalho dos PDFs", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "RELSSR_12_DISPONIBILIDADE_COMPOSTA_SUSPENSAO", "AUTO", "Validar disponibilidade composta", "Executar TV2_RunRelatoriosSuspensoesStrikesReset", "Empresa suspensa com OS aberta ou Pre-OS pendente mostra ambos os sinais", "Linha RELSSR_12 no resultado", "Suspensao segue bloqueio principal sem ocultar ocupacao adicional", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "RELSSR_13_IMPRESSOS_AVISO_CORPO_OBSERVACOES", "AUTO", "Validar aviso no corpo", "Executar TV2_RunRelatoriosSuspensoesStrikesReset", "Pre-OS/OS usam B29/B30; avaliacao usa Observacoes", "Linha RELSSR_13 no resultado", "Impede retorno do texto longo espremido no cabecalho", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "RELSSR_14_IMPRESSOS_LIMPEZA_AVISO_CORPO", "AUTO", "Validar limpeza B24/B29/B30", "Executar TV2_RunRelatoriosSuspensoesStrikesReset", "LimparOS e LimparPREOS removem aviso legado de B24 e ativo de B29/B30", "Linha RELSSR_14 no resultado", "Evita residuo visual entre impressoes", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "RELSSR_15_IMPRESSOS_AVISO_RODAPE_LEGIVEL", "AUTO", "Validar aviso em B29/B30", "Executar TV2_RunRelatoriosSuspensoesStrikesReset", "Aviso operacional usa B29:K30 com fonte 7, sem WrapText e sem ShrinkToFit", "Linha RELSSR_15 no resultado", "Evita texto colado nas bordas", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "RELSSR_16_RELATORIOS_LARGURA_UTIL", "AUTO", "Validar largura util", "Executar TV2_RunRelatoriosSuspensoesStrikesReset", "Rel_DefinirAreaImpressao ajusta zoom pela largura util quando sobra area impressa", "Linha RELSSR_16 no resultado", "Melhora leitura dos relatorios largos", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "CFGCSV_01_CONTROLES_TODOS_CAMPOS", "AUTO", "Validar campos da matriz de configuracao", "Executar TV2_RunConfigCenariosNovoPeriodo somente em base de homologacao", "Todos os controles de persistencia existem", "Linha CFGCSV_01 no resultado", "Evita teste parcial sobre UI incompleta", "AUTOMATIZADO_DESTRUTIVO"
    TV2_AddRoteiro ws, nr, "CFGCSV_02_CENARIO_1_ROUNDTRIP", "AUTO", "Validar persistencia com valores 1", "Executar TV2_RunConfigCenariosNovoPeriodo", "CONFIG e getters retornam 1 nos campos numericos; textos contem build", "Linha CFGCSV_02 e CSV de evidencia", "Cobre borda minima positiva", "AUTOMATIZADO_DESTRUTIVO"
    TV2_AddRoteiro ws, nr, "CFGCSV_03_CENARIO_2_ROUNDTRIP", "AUTO", "Validar persistencia com valores 2", "Executar TV2_RunConfigCenariosNovoPeriodo", "CONFIG e getters retornam 2 nos campos numericos; textos contem build", "Linha CFGCSV_03 e CSV de evidencia", "Cobre variacao maior que 1", "AUTOMATIZADO_DESTRUTIVO"
    TV2_AddRoteiro ws, nr, "CFGCSV_04_REGRA_RECUSA_DIAS", "AUTO", "Validar consumo por recusa/prazo", "Executar TV2_RunConfigCenariosNovoPeriodo", "Recusa controlada suspende por 1 dia", "Linha CFGCSV_04 e CSV de evidencia", "Liga UI persistida ao rodizio", "AUTOMATIZADO_DESTRUTIVO"
    TV2_AddRoteiro ws, nr, "CFGCSV_05_REGRA_STRIKE_DIAS", "AUTO", "Validar consumo por avaliacao/strike", "Executar TV2_RunConfigCenariosNovoPeriodo", "Duas notas 1 com corte 2 suspendem por 2 dias", "Linha CFGCSV_05 e CSV de evidencia", "Liga UI persistida ao servico de avaliacao", "AUTOMATIZADO_DESTRUTIVO"
    TV2_AddRoteiro ws, nr, "CFGCSV_06_NOVO_PERIODO_COPIA_LIMPEZA", "AUTO", "Validar Novo Periodo deterministico", "Executar TV2_RunConfigCenariosNovoPeriodo", "Pasta V12-0-0206-Onda-38-2-30 criada, copia existe, PRE_OS=0 e CAD_OS=0", "Linha CFGCSV_06", "Confirma copia antes da limpeza destrutiva", "AUTOMATIZADO_DESTRUTIVO"
    TV2_AddRoteiro ws, nr, "CFGCSV_07_CSV_EVIDENCIA", "AUTO", "Validar CSV de evidencia", "Abrir a pasta V12-0-0206-Onda-38-2-30 apos a suite", "CSV TesteV2_CONFIG_CENARIOS_<execucao>.csv existe junto da copia", "Linha CFGCSV_07 e arquivo CSV", "Permite auditoria humana sem PDF", "AUTOMATIZADO_DESTRUTIVO"
    ...
    TV2_AddRoteiro ws, nr, "UI_ADV_010_CENTRAL_V2_EXPOE_SUITE", "AUTO", "Validar exposicao da suite na Central V2", "Executar TV2_RunAdversarial_UI False e conferir a linha automatizada", "Wrapper, texto de menu e entrada RVS presentes", "Linha UI_ADV_010 no resultado", "Garante que a suite nova esteja acessivel ao humano", "AUTOMATIZADO"
...
'   DIAS_SUSPENSAO_STRIKE=30). Suites que precisam de outros valores
...
Public Sub TV2_RestaurarConfigBaseline( _
    ...
    Optional ByVal diasSusp As Long = 30, _
    Optional ByVal diasRecusaPrazo As Long = 30 _
)
    Dim ws As Worksheet
    Dim estavaProtegida As Boolean
    Dim senhaProtecao As String
    ...
    If Util_PrepararAbaParaEscrita(ws, estavaProtegida, senhaProtecao) Then
        ...
        ws.Cells(1, COL_CFG_DIAS_SUSPENSAO_RECUSA_PRAZO).Value = "DIAS_SUSPENSAO_RECUSA_PRAZO"
        ws.Cells(LINHA_CFG_VALORES, COL_CFG_DIAS_SUSPENSAO_RECUSA_PRAZO).Value = diasRecusaPrazo
        Util_RestaurarProtecaoAba ws, estavaProtegida, senhaProtecao
    End If
    On Error GoTo 0
End Sub
