...
Public Sub TV2_GerarCatalogoBase()
    ...
    TV2_AddCatalogo ws, nr, "RELSSR_11_IMPRESSOS_C16_ALINHAMENTO_LEGIVEL", "REL_SUSP_STRIKES_RESET", "RAPIDO", "AUTO", "Impressao", "C16 com alinhamento legivel", "Preencher no pacote fonte", "Validar que aviso operacional neutraliza alinhamento distribuido do template sem encolher a fonte", "C16:N16 alinhado a esquerda, centralizado verticalmente, sem wrap e sem ShrinkToFit", "Evita caracteres artificialmente espacado nos PDFs", "AUTOMATIZADO_0206", "Executar TV2_RunRelatoriosSuspensoesStrikesReset"
    ...
    TV2_AddCatalogo ws, nr, "RELSSR_13_IMPRESSOS_C16_AVISO_CURTO_LEGIVEL", "REL_SUSP_STRIKES_RESET", "RAPIDO", "AUTO", "Impressao", "C16 com aviso curto", "Preencher no pacote fonte", "Validar que C16 usa resumo operacional curto e deixa diagnostico completo nas observacoes", "Tokens estruturais presentes e ShrinkToFit desativado", "Evita comprimir texto longo ate ficar ilegivel", "AUTOMATIZADO_0206", "Executar TV2_RunRelatoriosSuspensoesStrikesReset"
...
Private Sub TV2_GerarRoteiroAssistido()
    ...
    TV2_AddRoteiro ws, nr, "RELSSR_11_IMPRESSOS_C16_ALINHAMENTO_LEGIVEL", "AUTO", "Validar alinhamento do aviso C16", "Executar TV2_RunRelatoriosSuspensoesStrikesReset", "C16:N16 fica alinhado a esquerda, centralizado verticalmente, sem wrap e sem ShrinkToFit", "Linha RELSSR_11 no resultado", "Evita caracteres artificialmente espacado nos PDFs", "AUTOMATIZADO"
    ...
    TV2_AddRoteiro ws, nr, "RELSSR_13_IMPRESSOS_C16_AVISO_CURTO_LEGIVEL", "AUTO", "Validar aviso curto no C16", "Executar TV2_RunRelatoriosSuspensoesStrikesReset", "C16 usa resumo operacional curto; diagnostico completo continua nas observacoes", "Linha RELSSR_13 no resultado", "Impede retorno do texto longo espremido em fonte ilegivel", "AUTOMATIZADO"
