...
Private Sub TV2_GerarRoteiroAssistido()
    ...
    TV2_AddRoteiro ws, nr, "RELSSR_13_IMPRESSOS_AVISO_CORPO_OBSERVACOES", "AUTO", "Validar aviso no corpo", "Executar TV2_RunRelatoriosSuspensoesStrikesReset", "Pre-OS/OS usam B30; avaliacao usa Observacoes", "Linha RELSSR_13 no resultado", "Impede retorno do texto longo espremido no cabecalho", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "RELSSR_14_IMPRESSOS_LIMPEZA_AVISO_CORPO", "AUTO", "Validar limpeza B24/B30", "Executar TV2_RunRelatoriosSuspensoesStrikesReset", "LimparOS e LimparPREOS removem aviso legado de B24 e ativo de B30", "Linha RELSSR_14 no resultado", "Evita residuo visual entre impressoes", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "RELSSR_15_IMPRESSOS_AVISO_RODAPE_LEGIVEL", "AUTO", "Validar aviso em B30", "Executar TV2_RunRelatoriosSuspensoesStrikesReset", "Aviso operacional usa B30:K30 com fonte 7, sem WrapText e sem ShrinkToFit", "Linha RELSSR_15 no resultado", "Evita texto colado nas bordas", "AUTOMATIZADO"
    TV2_AddRoteiro ws, nr, "RELSSR_16_RELATORIOS_LARGURA_UTIL", "AUTO", "Validar largura util", "Executar TV2_RunRelatoriosSuspensoesStrikesReset", "Rel_ConfigurarPagina usa margens laterais de 0,2 cm e FitToPage", "Linha RELSSR_16 no resultado", "Melhora leitura dos relatorios largos", "AUTOMATIZADO"
