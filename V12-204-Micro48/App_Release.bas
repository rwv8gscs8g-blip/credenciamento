...
Public Const APP_BUILD_IMPORTADO As String = "f7aa84f+ONDA24.MD24.3-avaliacao-dual-counter"
Public Const APP_BUILD_BRANCH As String = "codex/v12-0-0203-governanca-testes"
Public Const APP_BUILD_GERADO_EM As String = "2026-05-09 17:25"
...
Public Const APP_RELEASE_TEST_KEY As String = "sexteto-v204-onda24-md24-3-2026-05-09"
