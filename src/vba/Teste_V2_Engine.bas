...
Public Sub TV2_GerarCatalogoBase()
    ...
    TV2_AddCatalogo ws, nr, "CS_16", "CANONICO", "COMPLETO", "AUTO", "Suspensão", "Retorno ordenado de B após fim da suspensão", "B suspensa por nota com prazo vencido; A ainda com OS aberta", "Validar reativação automática sem perda dupla de turno", "C consome o turno livre; B volta na emissão seguinte", "Prova retorno justo após penalidade temporária", "AUTOMATIZADO_0203", "Executado na suíte canônica"
...
Private Sub TV2_GerarRoteiroAssistido()
    ...
    TV2_AddRoteiro ws, nr, "CS_16", "AUTO", "Validar retorno ordenado após suspensão por nota", "Executar a suíte canônica e conferir a linha CS_16", "C consome o turno livre; B volta na emissão seguinte", "Linhas CS_16 no resultado", "Prova que a suspensão temporária não causa perda dupla de turno", "AUTOMATIZADO"
