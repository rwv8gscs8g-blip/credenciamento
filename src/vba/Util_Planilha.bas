...
Public Function Util_SenhaProtecaoLegada() As String
    Util_SenhaProtecaoLegada = _
...
Public Function Util_SenhasTentativaProtecao() As Variant
    Util_SenhasTentativaProtecao = Array( _
        ...
        Util_SenhaProtecaoLegada(), _
        UCase$(Util_SenhaProtecaoLegada()) _
    )
End Function
...
' Le coluna A da aba (COL_*_ID = 1 para todas as abas que usam
' ProximoId) de LINHA_DADOS ate UltimaLinhaAba e retorna o maior
' ID numerico encontrado. Aba inexistente retorna 0 sem erro fatal.
' Promovido a Public na Onda 38.2.1-AR1-FIX2-PERF para servir tanto
' Util_Sanear_Contadores quanto a defesa em profundidade de ProximoId.
Public Function Util_MaxIdNaColunaA(ByVal nomeAba As String) As Long
    Dim ws As Worksheet
