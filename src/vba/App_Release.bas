...
' evitam falha de resolucao do VBE em chamada qualificada Repo_OS.*.
Public Const APP_BUILD_IMPORTADO As String = "f7aa84f+ONDA21.MD21.5-emitir-os-rollback-fix1"
...
Public Const APP_RELEASE_TEST_KEY As String = "quinteto-v204-onda21-md21-5-fix1-2026-05-05"
