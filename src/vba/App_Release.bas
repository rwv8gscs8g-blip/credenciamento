...
Public Const APP_BUILD_IMPORTADO As String = "f7aa84f+ONDA22.MD22.1-backfill-dt-ult-reativ"
...
Public Const APP_RELEASE_TEST_KEY As String = "quinteto-v204-onda22-md22-1-2026-05-06"
