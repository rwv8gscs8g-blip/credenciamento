...
Public Sub TV2_GerarCatalogoBase()
    ...
    TV2_AddCatalogo ws, nr, "MIG_003", "MIGRACAO", "RAPIDO", "AUTO", "Avaliacao", "Divergencia exige justificativa no servico", "Regra de justificativa migrada da interface para o servico", "Validar rejeicao de divergencia sem justificativa", "Servico rejeita divergencia sem motivo", "Fecha lacuna de regra de negocio", "AUTOMATIZADO_ATUAL", "Executado no smoke"
...
Private Sub TV2_GerarRoteiroAssistido()
    ...
    TV2_AddRoteiro ws, nr, "MIG_003", "AUTO", "Validar justificativa obrigatoria na divergencia", "Apenas conferir o resultado automatizado do cenario", "Servico falha e mantem a OS em execucao", "Linha do cenario MIG_003", "Fecha a lacuna de regra de negocio na avaliacao", "AUTOMATIZADO"
