---
titulo: 37 - Procedimento Import MICRO35 Onda 21 V204
diataxis: how-to
...
# Procedimento de Importacao - MICRO35

## 1. Pre-requisito

1. Workbook com MICRO34 importada.
2. VBAProject compilando limpo.
3. Quinteto MICRO34 aprovado:
   `V1=171/0+V2_Smoke=28/0+V2_Canonica=24/0+E2E_Strikes=71/0+IntegridadeBase=3/0`.

## 2. Comando para Janela Imediata

```vb
ImportarPacoteV3_Delta "MICRO35", "f7aa84f+ONDA21.MD21.5-emitir-os-rollback"
```
