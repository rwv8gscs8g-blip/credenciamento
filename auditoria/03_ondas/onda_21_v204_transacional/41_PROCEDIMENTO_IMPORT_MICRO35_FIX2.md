---
titulo: 41 - Procedimento Import MICRO35 Fix2
diataxis: how-to
...
# Procedimento de Importacao - MICRO35-fix2
...
```vb
ImportarPacoteV3_Delta "MICRO35-fix2", "f7aa84f+ONDA21.MD21.5-emitir-os-rollback-fix2"
```
