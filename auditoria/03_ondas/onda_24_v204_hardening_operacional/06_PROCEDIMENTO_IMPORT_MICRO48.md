---
titulo: Procedimento de Importacao MICRO48
diataxis: how-to
...
# Procedimento de Importacao MICRO48
...
```vb
ImportarPacoteV3_Delta "MICRO48", "f7aa84f+ONDA24.MD24.3-avaliacao-dual-counter"
```
...
Esperado: `OK=76 | FALHA=0 | MANUAL=0`.
