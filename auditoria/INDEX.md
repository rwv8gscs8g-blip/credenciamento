...
> Estrutura reorganizada na Onda 6 (28/04/2026) por tipo, preservando
> numeracao historica como prefixo dentro das subpastas. Detalhes em
> [`auditoria/03_ondas/onda_06_consolidacao_documental/41_TECNICO.md`](03_ondas/onda_06_consolidacao_documental/41_TECNICO.md).

## Sumarios cronologicos (raiz)

- [40_TRANSICAO_RACIONALIZACAO_E_PROMPT_RETOMADA.md](40_TRANSICAO_RACIONALIZACAO_E_PROMPT_RETOMADA.md) — auditoria honesta + plano (origem da Onda 6)
...
- [00_status/88_AUDITORIA_PLANEJAMENTO_V206_CLAUDE_OPUS.md](00_status/88_AUDITORIA_PLANEJAMENTO_V206_CLAUDE_OPUS.md) — auditoria V206-P1 Claude Opus
...
- [00_status/26_DIAGNOSTICO_LOOPING_CODEX_E_PROMPT_RETOMADA.md](00_status/26_DIAGNOSTICO_LOOPING_CODEX_E_PROMPT_RETOMADA.md) — diagnostico + prompt de retomada

## 01_regras_e_governanca/ — regras canonicas

- [01_regras_e_governanca/00_REGRAS_V203_INEGOCIAVEIS.md](01_regras_e_governanca/00_REGRAS_V203_INEGOCIAVEIS.md) — **constituicao operacional V12.0.0203 (10 regras)**
- [01_regras_e_governanca/03_AUDITORIA_REGRAS_DE_NEGOCIO.md](01_regras_e_governanca/03_AUDITORIA_REGRAS_DE_NEGOCIO.md)
- [01_regras_e_governanca/04_MATRIZ_MESTRE_DE_TESTES.md](01_regras_e_governanca/04_MATRIZ_MESTRE_DE_TESTES.md)
- [01_regras_e_governanca/14_FECHAMENTO_BACKLOG_OPUS_V12_0202.md](01_regras_e_governanca/14_FECHAMENTO_BACKLOG_OPUS_V12_0202.md)
- [01_regras_e_governanca/16_AUDITORIA_OPUS_PUBLICACAO_V12_0202.md](01_regras_e_governanca/16_AUDITORIA_OPUS_PUBLICACAO_V12_0202.md)
- [01_regras_e_governanca/17_PARECER_LICENCIAMENTO_TPGL_v1_1.md](01_regras_e_governanca/17_PARECER_LICENCIAMENTO_TPGL_v1_1.md)
- [01_regras_e_governanca/18_AUDITORIA_PUBLICACAO_OFICIAL_V12_0202.md](01_regras_e_governanca/18_AUDITORIA_PUBLICACAO_OFICIAL_V12_0202.md)
- [01_regras_e_governanca/19_AUDITORIA_PONTOS_FORTES_V12_0202.md](01_regras_e_governanca/19_AUDITORIA_PONTOS_FORTES_V12_0202.md)
- [01_regras_e_governanca/21_AUDITORIA_UNIFICADA_TESTES_V12_0203.md](01_regras_e_governanca/21_AUDITORIA_UNIFICADA_TESTES_V12_0203.md)
- [01_regras_e_governanca/23_PARECER_OPUS_FECHAMENTO_E_ORGANIZACAO_V12_0203.md](01_regras_e_governanca/23_PARECER_OPUS_FECHAMENTO_E_ORGANIZACAO_V12_0203.md)
...
- [02_planos/32_ROADMAP_V206_CONSOLIDADO.md](02_planos/32_ROADMAP_V206_CONSOLIDADO.md) — roadmap consolidado V206
...
- [02_planos/27_PLANO_ESTEIRA_OPUS_RELEASE_V203.md](02_planos/27_PLANO_ESTEIRA_OPUS_RELEASE_V203.md)

## 03_ondas/ — documentacao tecnica de cada onda

| Onda | Pasta | Tema |
|---|---|---|
| 1 | [03_ondas/onda_01_strikes/](03_ondas/onda_01_strikes/) | regra de strikes na avaliacao |
| 2 | [03_ondas/onda_02_cnae_snapshot/](03_ondas/onda_02_cnae_snapshot/) | snapshot CAD_SERV + dedup |
| 3 | [03_ondas/onda_03_cnae_dedup/](03_ondas/onda_03_cnae_dedup/) | dedup automatico + housekeeping |
...
- A ausencia de numeracao continua nao implica ausencia de documento — auditoria/39 foi consolidado em outros lugares na Onda 6.
- O status vigente deve ser lido em conjunto com [`obsidian-vault/00-DASHBOARD.md`](../obsidian-vault/00-DASHBOARD.md) e [`.hbn/relay/INDEX.md`](../.hbn/relay/INDEX.md).
- Para IAs em ciclo de execucao, comecar por [`AGENTS.md`](../AGENTS.md) na raiz, nao por este indice.
