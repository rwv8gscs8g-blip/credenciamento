...
Public Sub CT2_AbrirCentral()
    ...
    op = Trim$(InputBox( _
        ...
        "[14] Strikes na avaliacao (~2 min)" & vbCrLf & vbCrLf & _
        "Digite o numero:", _
...
' V12.0.0203 ONDA 10 Microdelta 1.5 fix4 - opcao [14] passa a chamar
' a suite end-to-end TV2_RunRodizioStrikesEndToEnd (cenarios CS_E2E_*),
' que substitui TV2_RunStrikes (deprecated). A nova suite usa rodizio
' natural sem manipular fila e e idempotente por design.
