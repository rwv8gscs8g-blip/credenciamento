...
Private Const IV3_VERSION As String = "V3.1-Onda10-Delta"
Private Const IV3_MANIFESTO_REL As String = "local-ai\vba_import_v3_phase1\000-MANIFESTO-V3-PHASE1.txt"
Private Const IV3_VBA_IMPORT_DIR_REL As String = "local-ai\vba_import_v3_phase1\"
...
Private Const IV3_DELTA_MANIFESTO_PREFIX As String = "local-ai\vba_import_v3_phase1\000-MANIFESTO-V3-DELTA-"
Private Const IV3_DELTA_MANIFESTO_SUFFIX As String = ".txt"
Private Const IV3_APP_RELEASE_REL_PATH As String = "local-ai\vba_import_v3_phase1\001-modulo\AAX-App_Release.bas"
